...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        cancelTitle: 'Anular la subida en cusro',
        uploadLabel: 'Subir',
        uploadTitle: 'Subir archivos seleccionados',
        msgNo: 'No',
        msgNoFilesSelected: 'No hay archivos seleccionados',
        msgCancelled: 'cancelando',
        msgZoomModalHeading: 'Vista previa detallada',
        msgSizeTooSmall: 'Archivo "{name}" (<b>{size} KB</b>) es demasiado pequeño y debe ser mayor que <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'Archivo "{name}" (<b>{size} KB</b>) excede el tamaño máximo de carga permitido de <b>{maxSize} KB</b>.',
        ...
        msgFilePreviewAborted: 'Se ha anulado la vista previa del archivo "{name}".',
        msgFilePreviewError: 'Se ha producido un error al leer el archivo "{name}".',
        msgInvalidFileName: 'Caracteres no válidos o no admitidos en el nombre de archivo "{name}".',
        msgInvalidFileType: 'Tipo no válido para el archivo "{name}". Solamente "{types}" archivos son compatibles.',
        msgInvalidFileExtension: 'Extensión no válida para el archivo "{name}". Solamente "{extensions}" archivos son compatibles.',
        msgFileTypes: {
            'excel': 'excel'
        },
        msgUploadAborted: 'Se interrumpió la subida del archivo.',
        msgUploadThreshold: 'Prosesando...',
        msgUploadBegin: 'Inicializando...',
        msgUploadEnd: 'Realizdo',
        msgUploadEmpty: 'No hay datos válidos disponibles para subir.',
        msgValidationError: 'Error al validar',
        msgLoading: 'Cargando archivo {index} de {files} &hellip;',
        msgProgress: 'Cargando archivo {index} de {files} - {name} - {percent}% completados.',
        msgSelected: '{n} {files} seleccionados',
        msgFoldersNotAllowed: 'Sólo arrastrar y soltar archivos! {n} Carpeta(s) han sido omitidas.',
        msgImageWidthSmall: 'Ancho del archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageHeightSmall: 'Altura del archivo de imagen "{name}" al menos debe ser {size} px.',
        msgImageWidthLarge: 'Ancho del archivo de imagen "{name}" no puedes exceder {size} px.',
        msgImageHeightLarge: 'Altura del archivo de imagen "{name}" no puedes exceder {size} px.',
        msgImageResizeError: 'No se pudieron obtener las dimensiones de la imagen para cambiar el tamaño.',
        msgImageResizeException: 'Error al cambiar el tamaño de la imagen.<pre>{errors}</pre>',
        msgAjaxError: 'Algo salió mal con el {operation} operacion. Por favor, inténtelo de nuevo más tarde!',
        msgAjaxProgressError: '{operation} Falló',
        ajaxOperations: {
            deleteThumb: 'Borrar archivo',
            uploadThumb: 'Subir archivo',
            uploadBatch: 'Subida de archivos por lotes',
            uploadExtra: 'Carga de datos de formulario'
        },
        dropZoneTitle: 'Arrastrar y soltar archivos aquí &hellip;',
        dropZoneClickTitle: '<br>(O haga clic para seleccionar {files})',
        previewZoomButtonTitles: {
            prev: 'Ver archivo anterior',
            next: 'Ver archivo siguiente',
            toggleheader: 'Alternar el encabezado',
            fullscreen: 'Alternar pantalla completa',
            borderless: 'Cambiar el modo sin bordes',
